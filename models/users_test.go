...
func testUserToManyOptions(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := UserSlice{&a}
	if err = a.L.LoadOptions(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testUserToManyQuestions(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	question, err := a.Questions().All(ctx, tx)
	if err != nil {
		t.Fatal(err)
	}
	...
	slice := UserSlice{&a}
	if err = a.L.LoadQuestions(ctx, tx, false, (*[]*User)(&slice), nil); err != nil {
		t.Fatal(err)
	}
	...
	a.R.Questions = nil
	if err = a.L.LoadQuestions(ctx, tx, true, &a, nil); err != nil {
		t.Fatal(err)
	}
	if got := len(a.R.Questions); got != 2 {
		t.Error("number of eager loaded records wrong, got:", got)
...
func testUserToManyAddOpOptions(t *testing.T) {
	var err error
...
func testUserToManySetOpOptions(t *testing.T) {
	var err error
...
func testUserToManyRemoveOpOptions(t *testing.T) {
	var err error
...
func testUserToManyAddOpQuestions(t *testing.T) {
	var err error
	...
	for i, x := range foreignersSplitByInsertion {
		err = a.AddQuestions(ctx, tx, i != 0, x...)
		if err != nil {
			t.Fatal(err)
		}
		...
		count, err := a.Questions().Count(ctx, tx)
		if err != nil {
			t.Fatal(err)
		}
		if want := int64((i + 1) * 2); count != want {
...
func testUserToManySetOpQuestions(t *testing.T) {
	var err error
	...
	err = a.SetQuestions(ctx, tx, false, &b, &c)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.SetQuestions(ctx, tx, true, &d, &e)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManyRemoveOpQuestions(t *testing.T) {
	var err error
	...
	err = a.AddQuestions(ctx, tx, true, foreigners...)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = a.RemoveQuestions(ctx, tx, foreigners[:2]...)
	if err != nil {
		t.Fatal(err)
	}
...
func testUserToManySetOpVotes(t *testing.T) {
	var err error
...
func testUserToManyRemoveOpVotes(t *testing.T) {
	var err error
...
var (
	userDBTypes = map[string]string{`CreatedAt`: `timestamp with time zone`, `Email`: `character varying`, `FirstName`: `character varying`, `ID`: `integer`, `LastName`: `character varying`, `PasswordDigest`: `character varying`, `Phone`: `character varying`, `UpdatedAt`: `timestamp with time zone`}
	_           = bytes.MinRead
)
